...
<c:url var="newURL" value="/quan-tri/bai-viet/danh-sach" /> <!-- ajax -->
...
<!-- e.preventDefault(); để submit vào url muốn đến (http://localhost:8080/api/new) -->
<!-- $'#btnAddOrUpdateNew' gọi id -->
<!-- serializeArray() lấy toàn bộ giá trị từ $('#formSubmit') -->
<!-- newId lấy giá trị tại ô đánh dấu -->
<!-- khởi tạo mảng var data = {} mục đích là put formData vào data-->
<!-- dùng mảng data trả về kiểu json về cho api -->
<script>
	...
	function addNew(data){
		$.ajax({
            url: '${newAPI}', // chỗ design url (http://localhost:8080/api/new)
            type: 'POST',
            ...
            error: function (error) {
            	// thất bại thì quay về trang danh sách
